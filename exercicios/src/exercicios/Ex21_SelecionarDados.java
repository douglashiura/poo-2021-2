...
public class Ex21_SelecionarDados extends JFrame {
	private static final long serialVersionUID = 1L;
	private Connection con;
	private Statement st;
	publicEx21_SelecionarDados throws SQLException
	{
			...
			}try
	{
		...
		while (resultSet.next()) {
			System.out.println();
			String linha = "";
			for (int x = 1; x <= numberOfColumns; x++) {// exibeo conteudodoscampos
	...
	public static void main (String args[]) throws SQLException {
		Ex21_SelecionarDados ex = new Ex21_SelecionarDados();
