...
public class HistoricoGUI implements ActionListener {
	...
	private Font myFont = new Font("Sans-Serif", Font.BOLD, 15);
	...
	public HistoricoGUI(HistoricoController historico) {
		...
		preencherTabela();
		tabela.setBounds(5, botao.getY() + (int) botao.getSize().getHeight() + 5, frameWidth - 25,
				(int) (frameHeight * 0.7));
	...
	private void preencherTabela() {
		...
		histController.list().forEach((Integer i, Expressao e) -> {
