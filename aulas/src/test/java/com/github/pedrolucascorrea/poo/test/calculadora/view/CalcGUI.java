...
import br.com.bruno.controller.ExpressaoController;
...
public class CalcGUI implements ActionListener {
	...
	private Font myFont = new Font("Sans-Serif",Font.BOLD,30);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(comando.equals("=")) {
			...
			if(!textoAtual.isBlank() && 
					(Character.isDigit(textoAtual.charAt(textoAtual.length()-1)) ||
			...
			if(textoAtual.isBlank()||
					isMainFunction(textoAtual.charAt(textoAtual.length()-1))||
