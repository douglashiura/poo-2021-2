...
public class TelaInicial extends JPanel{
	...
	private JButton btnSair = new JButton("Help");
	private JButton btnAjuda = new JButton("Sair");
	...
	public void criarTela() throws InterruptedException {
		...
		btnSair.setBounds(1, 0, 200, 24);
		btnSair.setForeground(Color.white);
		btnSair.setBackground(Color.gray);
		btnSair.setVisible(true);
		
		btnAjuda.setBounds(1166, 0, 200, 24);
		...
		btnAlavanca.setBorder(BorderFactory.createLineBorder(Color.blue, 1));
		btnAlavanca.setVisible(true);
		
		labelEstorno.setBounds(450, -25, 500, 100);
