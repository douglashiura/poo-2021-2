...
public class E18_SelecionarDados extends JFrame {

	private Connection con;

	private Statement st;

public E18_SelecionarDados() throws SQLException {
...
// demais exceções
   ...
   public static void main(String args[]) throws SQLException{
	E18_SelecionarDados ex = new E18_SelecionarDados();
